...
- `src/` – circuit netlists, RTL modules, or schematic-related source files  
- `sim/` – simulation waveforms, logs, and test results  
- `prj/` – original project files generated by EDA tools  
  (e.g., Cadence Virtuoso libraries, FPGA project files, tool-specific metadata)  
- `doc/` – design documentation, architecture diagrams, timing illustrations,
  and explanatory notes  
- `archive/early_version/` – deprecated, exploratory, or intermediate design
  iterations documenting the design evolution  
- `README.md` – detailed technical description of the project  
- `report.md` – archived design reports summarizing early versions,
  known issues, and design decisions  

Supplementary figures, layout screenshots, and physical verification
evidence are included where applicable.
